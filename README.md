...
<p style="display:inline-block">
  Technical Skills: <br>
  - Programming languages :Python, Java, JS, C/C++,<br> Dart, React, Nodejs <br>
  - Databases :SQL (MySQL, PL/SQL, Oracle) ,<br> NoSQL (MongoDB, FireBase) <br>
  - Data Science Tools :Sklearn,Tensorflow,<br> Keras, Numpy, Pandas. <br>
  - Web Devolepment: Django(py), Flask(py),<br> React(js),vue(js),p5(js) <br>
</p>
